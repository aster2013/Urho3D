...
// File: magic.h
//
// Copyright (*T_)(c) Astralax. All rights reserved.
// Author: Sedov Alexey
//-----------------------------------------------------------------------------

// Modify by Aster Jian for Urho3D
...
typedef const char* (*T_Magic_FindFirst)(HM_FILE hmFile,MAGIC_FIND_DATA* data,int mode);
...
typedef const char* (*T_Magic_FindNext)(HM_FILE hmFile, MAGIC_FIND_DATA* data);
...
typedef const char* (*T_Magic_GetFileName)(HM_FILE hmFile);
...
typedef bool (*T_Magic_HasTextures)(HM_FILE hmFile);
...
typedef int (*T_Magic_GetStaticAtlasCount)(HM_FILE hmFile);
...
typedef bool (*T_Magic_InInterval)(HM_EMITTER hmEmitter);
...
typedef int (*T_Magic_EmitterToInterval1)(HM_EMITTER hmEmitter, float speed_factor, const char* file);
...
typedef int (*T_Magic_SetInterpolationMode)(HM_EMITTER hmEmitter,bool mode);
...
typedef bool (*T_Magic_IsRandomMode)(HM_EMITTER hmEmitter);
...
typedef int (*T_Magic_SetRandomMode)(HM_EMITTER hmEmitter,bool mode);
...
typedef int (*T_Magic_GetLoopMode)(HM_EMITTER hmEmitter);
...
typedef int (*T_Magic_GetEmitterType)(HM_EMITTER hmEmitter,int index);

// eng: Returns the ID of emitter
// rus: Возвращает идентификатор эмиттера
typedef unsigned int (*T_Magic_GetEmitterID)(HM_EMITTER hmEmitter);
...
typedef float (*T_Magic_GetUpdateSpeed)(HM_EMITTER hmEmitter);

// eng: Returns information about background image of emitter
// rus: Возвращает информацию о фоновом изображении эмиттера
typedef float (*T_Magic_GetBackgroundRect)(HM_EMITTER hmEmitter, MAGIC_RECT* rect);
...
typedef bool (*T_Magic_Is3d)(HM_EMITTER hmEmitter);
...
typedef int (*T_Magic_GetView)(HM_EMITTER hmEmitter, MAGIC_VIEW* view);
...
typedef int (*T_Magic_CorrectEmitterPosition)(HM_EMITTER hmEmitter, int scene_width, int scene_height);
#endif

// eng: Returns coordinates of the emitter
// rus: Возвращает координаты эмиттера
typedef int (*T_Magic_GetEmitterPosition)(HM_EMITTER hmEmitter,MAGIC_POSITION* pos);

// eng: Sets the coordinates of the emitter
// rus: Устанавливает координаты эмиттера
typedef int (*T_Magic_SetEmitterPosition)(HM_EMITTER hmEmitter,MAGIC_POSITION* pos);
...
typedef int (*T_Magic_SetEmitterPositionWithTail)(HM_EMITTER hmEmitter,MAGIC_POSITION* pos);

// eng: Returns the mode of the emitter coordinates
// rus: Возвращает режим координат эмиттера
typedef bool (*T_Magic_GetEmitterPositionMode)(HM_EMITTER hmEmitter);

// eng: Sets the mode of the emitter coordinates
// rus: Устанавливает режим координат эмиттера
typedef int (*T_Magic_SetEmitterPositionMode)(HM_EMITTER hmEmitter,bool mode);

// eng: Moves particles
// rus: Перемещает частицы
typedef int (*T_Magic_MoveEmitterParticles)(HM_EMITTER hmEmitter,MAGIC_POSITION* offset);

// eng: Returns emitter direction
// rus: Возвращает направление эмиттера
typedef int (*T_Magic_GetEmitterDirection)(HM_EMITTER hmEmitter,MAGIC_DIRECTION* direction);

// eng: Sets the direction of the emitter
// rus: Устанавливает направление эмиттера
typedef int (*T_Magic_SetEmitterDirection)(HM_EMITTER hmEmitter,MAGIC_DIRECTION* direction);

// eng: Gets the emitter's direction mode
// rus: Возвращает режим вращения эмиттера
typedef bool (*T_Magic_GetEmitterDirectionMode)(HM_EMITTER hmEmitter);

// eng: Sets emitter's rotation mode
// rus: Устанавливает режим вращения эмиттера
typedef int (*T_Magic_SetEmitterDirectionMode)(HM_EMITTER hmEmitter,bool mode);

// eng: Rotates particles
// rus: Вращает частицы
typedef int (*T_Magic_RotateEmitterParticles)(HM_EMITTER hmEmitter, MAGIC_DIRECTION* offset);

// eng: Returns the animate folder flag
// rus: Возвращает признак анимированной папки
typedef bool (*T_Magic_IsFolder)(HM_EMITTER hmEmitter);
...
typedef int (*T_Magic_GetEmitterCount)(HM_EMITTER hmEmitter);
...
typedef HM_EMITTER (*T_Magic_GetEmitter)(HM_EMITTER hmEmitter,int index);
...
typedef int (*T_Magic_CreateFirstRenderedParticlesList)(HM_EMITTER hmEmitter, MAGIC_RENDERING* rendering);
...
typedef void (*T_Magic_CreateNextRenderedParticlesList)(MAGIC_RENDERING* rendering);
...
typedef int (*T_Magic_GetNextParticleVertexes)(MAGIC_PARTICLE_VERTEXES* vertexes);

// eng: Returns particles sorting mode
// rus: Возвращает режим сортировки частиц
typedef int (*T_Magic_GetSortingMode)(HM_EMITTER hmEmitter);

// eng: Sets particles sorting mode
// rus: Устанавливает режим сортировки частиц
typedef int (*T_Magic_SetSortingMode)(HM_EMITTER hmEmitter, int mode);

// eng: Returnes Bounds Box
// rus: Возвращает BBox
typedef int (*T_Magic_GetBBox)(HM_EMITTER hmEmitter,MAGIC_BBOX* bbox);

// eng: Returns Bounds Box recalculation period
// rus: Возвращает период перерасчета Bounds Box
typedef int (*T_Magic_GetBBoxPeriod)(HM_EMITTER hmEmitter);

// eng: Sets Bounds Box recalculation period
// rus: Устанавливает период перерасчета Bounds Box
typedef int (*T_Magic_SetBBoxPeriod)(HM_EMITTER hmEmitter,int period);

// eng: Forces Bounds Box recalculation
// rus: Принудительно пересчитывает Bounds Box
typedef int (*T_Magic_RecalcBBox)(HM_EMITTER hmEmitter);
...
typedef int (*T_Magic_GetEmitterVariableCount)(HM_EMITTER hmEmitter);
...
typedef int (*T_Magic_GetEmitterVariable)(HM_EMITTER hmEmitter, int index, MAGIC_VARIABLE* variable);

// --------------------------------------------------------------------------------

// eng: Returns the name of the particles type
// rus: Возвращает имя типа частиц
typedef const char* (*T_Magic_GetParticlesTypeName)(HM_EMITTER hmEmitter, int index);

// eng: Returns the number particles type contained in emitter
// rus: Возвращает количество типов частиц внутри эмиттера
typedef int (*T_Magic_GetParticlesTypeCount)(HM_EMITTER hmEmitter);
...
typedef int (*T_Magic_LockParticlesType)(HM_EMITTER hmEmitter, int index);

// eng: Releases previously locked particles type
// rus: Освобождает захваченный ранее тип частиц
typedef int (*T_Magic_UnlockParticlesType)();
...
typedef int (*T_Magic_GetTextureCount)();
...
typedef int (*T_Magic_GetTexture)(int index, MAGIC_TEXTURE* texture);

// eng: Sets texture coordinates for specified frame-file
// rus: Устанавливает текстурные координаты для указанного файл-кадра
typedef int (*T_Magic_SetTextureUV)(int index, float left, float top, float right, float bottom);
...
typedef unsigned int (*T_Magic_GetTextureID)();
...
typedef int (*T_Magic_GetNextParticle)(MAGIC_PARTICLE* particle);
...
typedef void (*T_Magic_MoveParticle)(MAGIC_POSITION* offset);
...
typedef void (*T_Magic_RotateParticle)(MAGIC_DIRECTION* offset);
...
typedef int (*T_Magic_GetParticlesTypeVariableCount)();
...
typedef int (*T_Magic_GetParticlesTypeVariable)(int index, MAGIC_VARIABLE* variable);

// eng: Returns the count of actions
// rus: Возвращает количество действий
typedef int (*T_Magic_GetActionCount)();
...
typedef int (*T_Magic_GetAction)(int index, MAGIC_ACTION* action);

// eng: Creates new action
// rus: Создает новое действие
typedef int (*T_Magic_CreateAction)(MAGIC_ACTION* action);

// eng: Deletes specified action
// rus: Удаляет указанное действие
typedef int (*T_Magic_DestroyAction)(int index);
...
typedef int (*T_Magic_GetAttachedPhysicObjectsCount)(int type);
...
typedef int (*T_Magic_GetAttachedPhysicObjects)(int type, int* HMs);

// --------------------------------------------------------------------------

// eng: Sets the mode of atlas
// rus: Устанавливает режим работы атласа
typedef void (*T_Magic_SetCleverModeForAtlas)(bool clever);

// eng: Returns the mode of atlas
// rus: Возвращает режим работы атласа
typedef bool (*T_Magic_IsCleverModeForAtlas)();
...
typedef int (*T_Magic_ChangeImage)(HM_EMITTER hmEmitter, int type_index, int width, int height, unsigned char* data, int bytes_per_pixel);
...
typedef int (*T_Magic_ChangeModel)(HM_EMITTER hmEmitter, int type_index, int count, MAGIC_TRIANGLE* triangles);

// --------------------------------------------------------------------------------------

// eng: Creates a new key on a Timeline
// rus: Создает новый ключ указанного типа на Шкале времени
typedef int (*T_Magic_CreateKey)(HM_EMITTER hmEmitter, int type, MAGIC_KEY* key);

// eng: Deletes the specified key of desired type from Timeline
// rus: Удаляет выбранный ключ указанного типа со Шкалы времени
typedef int (*T_Magic_DeleteKey)(HM_EMITTER hmEmitter, int type, int index);
...
typedef int (*T_Magic_GetKeyCount)(HM_EMITTER hmEmitter, int type);

// eng: Returns information for the key of specified type
// rus: Возвращает информацию о ключе указанного типа
typedef int (*T_Magic_GetKey)(HM_EMITTER hmEmitter, int type, MAGIC_KEY* key, int index);

// eng: Sets the new data for the key of specified type
// rus: Устанавливает новые данные для ключа указанного типа
typedef int (*T_Magic_SetKey)(HM_EMITTER hmEmitter, int type, MAGIC_KEY* key, int index);

// --------------------------------------------------------------------------------------

// eng: Creates obstacle
// rus: Создает препятствие
typedef HM_OBSTACLE (*T_Magic_CreateObstacle)(MAGIC_OBSTACLE* data, MAGIC_POSITION* position, int cell);

// eng: Returns information about shape of obstacle
// rus: Возвращает информацию о форме препятствия
typedef int (*T_Magic_GetObstacleData)(HM_OBSTACLE hmObstacle, MAGIC_OBSTACLE* data);

// eng: Sets new shape of obstacle
// rus: Устанавливает новую форму для препятствия
typedef int (*T_Magic_SetObstacleData)(HM_OBSTACLE hmObstacle, MAGIC_OBSTACLE* data, int cell);

// eng: Returns position of obstacle
// rus: Возвращает позицию препятствия
typedef int (*T_Magic_GetObstaclePosition)(HM_OBSTACLE hmObstacle,MAGIC_POSITION* pos);

// eng: Sets new position of obstacle
// rus: Устанавливает новую позицию для препятствия
typedef int (*T_Magic_SetObstaclePosition)(HM_OBSTACLE hmObstacle,MAGIC_POSITION* pos);

// eng: Creates wind
// rus: Создает ветер
typedef HM_WIND (*T_Magic_CreateWind)(MAGIC_WIND* data);

// eng: Returns information about wind
// rus: Возвращает информацию о ветре
typedef int (*T_Magic_GetWindData)(HM_WIND hmWind, MAGIC_WIND* data);

// eng: Sets new properties for wind
// rus: Устанавливает новые свойства для ветра
typedef int (*T_Magic_SetWindData)(HM_WIND hmWind, MAGIC_WIND* data);

// eng: Deletes obstacle or wind
// rus: Уничтожает препятствие или ветер
typedef int (*T_Magic_DestroyPhysicObject)(int type, int HM);

// eng: Deletes all obstacles and winds
// rus: Уничтожает все препятствия или ветры
typedef int (*T_Magic_DestroyAllPhysicObjects)(int type);

// eng: Duplicates specified obstacle or wind
// rus: Снимает копию с указанного препятствия или ветра
typedef int (*T_Magic_DuplicatePhysicObject)(int type, int HM);

// --------------------------------------------------------------------------------------

// eng: Returns information about subsequent event
// rus: Возвращает информацию об очередном событии
typedef int (*T_Magic_GetNextEvent)(MAGIC_EVENT* evt);

// eng: Returns user data of particle
// rus: Возвращает пользовательские данные частицы
typedef void* (*T_Magic_ParticleGetData)(HM_PARTICLE hmParticle);

// eng: Sets user data of particle
// rus: Устанавливает пользовательские данные частицы
typedef void (*T_Magic_ParticleSetData)(HM_PARTICLE hmParticle, void* data);

// eng: Returns scene coordinates of particle
// rus: Возвращает координаты частицы на сцене
typedef void (*T_Magic_ParticleGetPosition)(HM_PARTICLE hmParticle, MAGIC_POSITION* pos);

// eng: Sets coordinates of particle
// rus: Устанавливает координаты частицы
typedef void (*T_Magic_ParticleSetPosition)(HM_PARTICLE hmParticle, MAGIC_POSITION* pos);

// eng: Returns specified property of particle
// rus: Возвращает указанное свойство частицы
typedef float (*T_Magic_ParticleGetProperty)(HM_PARTICLE hmParticle, int property);

// eng: Sets specified property of particle
// rus: Устанавливает указанное свойство частицы
typedef void (*T_Magic_ParticleSetProperty)(HM_PARTICLE hmParticle, int property, float value);

// eng: Returns several specified properties of particle
// rus: Возвращает несколько указанных свойств частицы
typedef void (*T_Magic_ParticleGetProperties)(HM_PARTICLE hmParticle, int count, int* properties, float* values);

// eng: Sets several specified properties of particle
// rus: Устанавливает несколько указанных свойств частицы
typedef void (*T_Magic_ParticleSetProperties)(HM_PARTICLE hmParticle, int count, int* properties, float* values);

// eng: Returns physical radius of particle
// rus: Возвращает физический радиус частицы
typedef float (*T_Magic_ParticleGetRadius)(HM_PARTICLE hmParticle);

// eng: Detaches particle from emitter
// rus: Отсоединяет частицу от эмиттера
typedef void (*T_Magic_ParticleDetaching)(HM_PARTICLE hmParticle);

// eng: Deletes particle
// rus: Уничтожает частицу
typedef void (*T_Magic_ParticleDestruction)(HM_PARTICLE hmParticle);

// --------------------------------------------------------------------------------------

// eng: Opens stream from file
// rus: Открывает поток из файла
typedef int (*T_Magic_StreamOpenFile)(const char* file_name, int mode);

// eng: Opens stream in memory
// rus: Открывает поток в памяти
typedef int (*T_Magic_StreamOpenMemory)(const char* address, unsigned int length, int mode);
...
typedef int (*T_Magic_StreamClose)(HM_STREAM hmStream);

// eng: Closing all opened streams
// rus: Закрытие всех открытых поток
typedef void (*T_Magic_StreamCloseAll)();

// eng: Returns the length of stream
// rus: Возвращает размер потока
typedef unsigned int (*T_Magic_StreamGetLength)(HM_STREAM hmStream);

// eng: Returns current stream position
// rus: Возвращает текущую позицию в потоке
typedef unsigned int (*T_Magic_StreamGetPosition)(HM_STREAM hmStream);
...
typedef int (*T_Magic_EmitterToInterval1_Stream)(HM_EMITTER hmEmitter, float speed_factor, HM_STREAM hmStream);

// --------------------------------------------------------------------------------------

typedef void (*T_Magic_DestroyAll)();
...
typedef int (*T_Magic_SetEmitterPositionWithAttachedPhysicObjects)(HM_EMITTER hmEmitter, MAGIC_POSITION* pos);
